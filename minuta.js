...
function atualizaMinuta() {
  ...
  minuta += estiloCorpo("I - <b>nos períodos de apuração de dezembro de 2008 em diante</b>, as contribuições previdenciárias devidas devem ser escrituradas no eSocial (evento S-2500), confessadas na DCTFWeb - Reclamatória Trabalhista (evento S-2501) e recolhidas mediante Documento de Arrecadação de Receitas Federais - DARF gerado pela DCTFWeb; e,");
  minuta += estiloCorpo("II - <b>nos períodos de apuração anteriores a dezembro de 2008</b>, as contribuições previdenciárias devidas devem ser escrituradas no eSocial (evento S-2500) e recolhidas pela Guia da Previdência Social - GPS, de acordo com a Resolução INSS/PR nº 657/1998, acompanhadas da prestação das informações de que trata o art. 32, IV, da Lei nº 8.212/1991, por meio da Guia de Recolhimento do FGTS e Informações à Previdência Social - GFIP.");
